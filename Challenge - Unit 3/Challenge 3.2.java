...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        students.add(new Student("Rajan", "A123", 3.8));
        students.add(new Student("VasanthRagav", "B456", 3.5));
        students.add(new Student("Selvam", "C789", 3.9));
        students.add(new Student("SaranRaj", "D101", 3.2));
        students.add(new Student("Krishna", "E202", 4.1));
